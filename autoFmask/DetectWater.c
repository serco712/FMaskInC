...
void binary_expand_op_13(emxArray_boolean_T *in1, const emxArray_real32_T *in2,
                         const ObjTOABT *in3)
{
  ...
  stride_1_0_tmp = (in3->BandNIR->size[0] != 1);
  stride_1_1_tmp = (in3->BandNIR->size[1] != 1);
  aux_0_1 = 0;
  aux_1_1 = 0;
  aux_2_1_tmp = 0;
  aux_3_1_tmp = 0;
  for (i = 0; i < b_loop_ub; i++) {
    for (i1 = 0; i1 < loop_ub; i1++) {
      ...
      f1 = in3->BandNIR
               ->data[i1 * stride_1_0_tmp + in3->BandNIR->size[0] * aux_1_1];
