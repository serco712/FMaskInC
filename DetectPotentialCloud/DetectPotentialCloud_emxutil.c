...
{
  emxFreeStruct_rtString(&pStruct->Name);
  emxFreeStruct_rtString(&pStruct->Sensor);
  emxFreeStruct_rtString(&pStruct->Output);
}
...
{
  emxInitStruct_rtString(&pStruct->Name);
  emxInitStruct_rtString(&pStruct->Sensor);
  emxInitStruct_rtString(&pStruct->Output);
}
