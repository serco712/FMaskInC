...
void binary_expand_op_10(emxArray_real32_T *in1, const ObjTOABT *in2)
{
  ...
  stride_1_0 = (in2->BandGreen->size[0] != 1);
  stride_1_1 = (in2->BandGreen->size[1] != 1);
  stride_2_0 = (in2->BandRed->size[0] != 1);
  stride_2_1 = (in2->BandRed->size[1] != 1);
  aux_0_1 = 0;
  aux_1_1 = 0;
  aux_2_1 = 0;
    ...
    for (i1 = 0; i1 < loop_ub; i1++) {
      in1_data[i1 + in1->size[0] * i] =
          ((in2->BandBlue
            ...
            in2->BandGreen
                ->data[i1 * stride_1_0 + in2->BandGreen->size[0] * aux_1_1]) +
           in2->BandRed
               ->data[i1 * stride_2_0 + in2->BandRed->size[0] * aux_2_1]) /
          3.0F;
    }
    aux_2_1 += stride_2_1;
    aux_1_1 += stride_1_1;
    ...
    for (i1 = 0; i1 < loop_ub; i1++) {
      in1_data[i1 + in1->size[0] * i] =
          (in2->BandNIR
           ...
           in2->BandRed
               ->data[i1 * stride_1_0 + in2->BandRed->size[0] * aux_1_1]) /
          in3_data[i1 * stride_2_0 + in3->size[0] * aux_2_1];
    }
    aux_2_1 += stride_2_1;
    aux_1_1 += stride_1_1;
