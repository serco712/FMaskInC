...
#include "main.h"
#include "NDVI.h"
#include "NDVI_emxAPI.h"
#include "NDVI_terminate.h"
...
void main_NDVI(void)
{
  ...
  emxArray_real32_T *red;
  /* Initialize function 'NDVI' input arguments. */
  /* Initialize function input argument 'red'. */
  red = c_argInit_UnboundedxUnbounded_r();
  /* Initialize function input argument 'nir'. */
  nir = c_argInit_UnboundedxUnbounded_r();
  /* Call the entry-point 'NDVI'. */
  emxInitArray_real32_T(&ndvi, 2);
  NDVI(red, nir, ndvi);
  emxDestroyArray_real32_T(nir);
  emxDestroyArray_real32_T(red);
