                    ...
                    emxArray_cell_wrap_14 *seq_DecomposedStrelArray)
{
  ...
  const cell_wrap_14 *obj_DecomposedStrelArray_data;
  ...
  if (obj_DecomposedStrelArray_data[0].f1->size[1] == 0) {
    ...
    emxEnsureCapacity_cell_wrap_141(seq_DecomposedStrelArray, i);
    ...
    for (n = 0; n < i; n++) {
      ...
      emxEnsureCapacity_cell_wrap_141(seq_DecomposedStrelArray, i1);
      seq_DecomposedStrelArray_data = seq_DecomposedStrelArray->data;
                      ...
                      double pad_lr_data[], int pad_lr_size[2])
{
  ...
  c_images_internal_coder_strel_S *seq_StrelArray_data;
  cell_wrap_23 subs[3];
  cell_wrap_30 *offsets_data;
  emxArray_cell_wrap_14 *expl_temp;
  emxArray_cell_wrap_30 *offsets;
  ...
  emxFreeMatrix_cell_wrap_23(subs);
  emxFree_int32_T(&idx);
        ...
        if (offsets_data[k].f1->size[1] >= 1) {
          for (b_ii = 0; b_ii < i2; b_ii++) {
            ...
            for (b_idx = 2; b_idx <= i1; b_idx++) {
              ...
              if (offsets__data[b_ii] > varargin_2) {
                offsets__data[b_ii] = varargin_2;
              }
            }
          }
        }
...
void strel_parenReference(strel *obj, double idx)
{
  ...
  emxArray_cell_wrap_14_1x1 decomposedStrelArray;
  int i;
  int loop_ub;
  ...
  emxCopyStruct_cell_wrap_14(&obj->DecomposedStrelArray->data[0],
                             &decomposedStrelArray.data[0]);
  emxFree_cell_wrap_14_1x1(&decomposedStrelArray);
}
                 ...
                 emxArray_cell_wrap_14 *obj_DecomposedStrelArray)
{
  ...
  cell_wrap_14 *obj_DecomposedStrelArray_data;
  d_emxArray_images_internal_code strelArray;
  emxArray_cell_wrap_14_1x1 decomposedStrelArray;
  ...
  emxEnsureCapacity_cell_wrap_141(obj_DecomposedStrelArray, i);
  obj_DecomposedStrelArray_data = obj_DecomposedStrelArray->data;
  emxCopyStruct_cell_wrap_14(&obj_DecomposedStrelArray_data[0],
                             &decomposedStrelArray.data[0]);
  emxFree_cell_wrap_14_1x1(&decomposedStrelArray);
}
